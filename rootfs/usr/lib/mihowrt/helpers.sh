...
MIHOWRT_HELPER_MODULES="${MIHOWRT_HELPER_MODULES:-validation.sh runtime-probe.sh config-io.sh mihomo-api.sh migration.sh fetch.sh diagnostics.sh version.sh package-update.sh}"
