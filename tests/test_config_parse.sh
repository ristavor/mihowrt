...
assert_eq "# ===== MihoWRT autogenerated API defaults BEGIN =====" "$(sed -n '3p' "$patch_candidate")" "yaml_prepend_autogenerated_scalars should insert defaults after YAML header"
assert_eq "# DO NOT EDIT: MihoWRT manages this block." "$(sed -n '4p' "$patch_candidate")" "yaml_prepend_autogenerated_scalars should mark generated defaults as managed"
assert_eq "# ===== MihoWRT autogenerated API defaults END =====" "$(sed -n '8p' "$patch_candidate")" "yaml_prepend_autogenerated_scalars should close generated defaults block"
...
yaml_prepend_autogenerated_scalars "$legacy_patch_candidate" "" "192.168.1.1:9090" ""
assert_eq "1" "$(grep -cF '# ===== MihoWRT autogenerated API defaults BEGIN =====' "$legacy_patch_candidate")" "yaml_prepend_autogenerated_scalars should collapse duplicate legacy generated markers"
assert_eq "1" "$(grep -cF '# ===== MihoWRT autogenerated API defaults END =====' "$legacy_patch_candidate")" "yaml_prepend_autogenerated_scalars should keep one generated block end marker"
assert_file_contains "$legacy_patch_candidate" "# DO NOT EDIT: MihoWRT manages this block." "yaml_prepend_autogenerated_scalars should mark migrated generated block as managed"
assert_file_not_contains "$legacy_patch_candidate" "# MihoWRT autogenerated API defaults" "yaml_prepend_autogenerated_scalars should remove legacy generated marker"
assert_eq "1" "$(grep -c '^external-controller:' "$legacy_patch_candidate")" "yaml_prepend_autogenerated_scalars should keep one generated external controller"
assert_eq "1" "$(grep -c '^external-controller-unix:' "$legacy_patch_candidate")" "yaml_prepend_autogenerated_scalars should keep old generated socket inside managed block"
assert_eq "1" "$(grep -c '^secret:' "$legacy_patch_candidate")" "yaml_prepend_autogenerated_scalars should keep old generated secret inside managed block"
assert_file_contains "$legacy_patch_candidate" "# keep user comment" "yaml_prepend_autogenerated_scalars should preserve user comments after legacy generated fields"

broken_marker_candidate="$tmpdir/broken-marker-config.yaml"
cat >"$broken_marker_candidate" <<'EOF'
# ===== MihoWRT autogenerated API defaults BEGIN =====
external-controller: 192.168.1.1:9090
mode: rule
EOF

yaml_prepend_autogenerated_scalars "$broken_marker_candidate" "/tmp/clash/mihomo.sock" "" "abcdef0123456789"
assert_file_contains "$broken_marker_candidate" "mode: rule" "yaml_prepend_autogenerated_scalars should preserve config after malformed generated block"
assert_file_contains "$broken_marker_candidate" "# DO NOT EDIT: MihoWRT manages this block." "yaml_prepend_autogenerated_scalars should still emit managed warning when patching malformed block"
