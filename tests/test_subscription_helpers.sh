...
assert_eq "mihowrt/$PKG_VERSION" "$(subscription_user_agent)" "subscription_user_agent should include package version"
...
assert_file_contains "$TEST_WGET_LOG" "-A mihowrt/$PKG_VERSION" "fetch_subscription_config should send MihoWRT user agent"
