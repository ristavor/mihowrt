...
assert_eq "mihowrt/0.7.3" "$(subscription_user_agent)" "subscription_user_agent should include package version"
...
assert_file_contains "$TEST_WGET_LOG" "-U mihowrt/0.7.3" "fetch_subscription_config should send MihoWRT user agent"
